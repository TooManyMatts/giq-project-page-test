...
class MaeFeaturizer:
    ...
    def encode_image(self, image, batch_size=32):
        """
        Encode a single image or a batch of images using the MAE model.
        """
        with torch.no_grad():
